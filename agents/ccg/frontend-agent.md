...
- 角色提示词：分析 `~/.claude/.ccg/prompts/gemini/analyzer.md` / 规划 `~/.claude/.ccg/prompts/gemini/architect.md` / 审查 `~/.claude/.ccg/prompts/gemini/reviewer.md`
...
调用 Gemini（`resume <GEMINI_SESSION>`）：
